...
export default function PageBuilderError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 text-center">
      ...
      <h1 className="mb-2 text-2xl font-bold">Page Builder Unavailable</h1>
      <p className="mb-8 text-muted-foreground max-w-md">
        The Page Builder encountered an error. Please try again.
      </p>
