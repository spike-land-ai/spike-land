...
/**
 * GET /api/codespace/[codeSpace]/version/[number]/code
 *
 * Returns the raw TSX source code for a specific immutable version.
 */
export async function GET(
  ...
  if (versionError) {
    logger.error(
      `[Codespace Code] Failed to get version ${versionNumber} for "${codeSpace}":`,
      versionError,
    );
