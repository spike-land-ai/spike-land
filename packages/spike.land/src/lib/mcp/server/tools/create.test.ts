...
describe("create tools", () => {
  ...
  describe("create_search_apps", () => {
    it("should return matching apps", async () => {
      ...
      const result = await registry.call("create_search_apps", { query: "tetris" });
    ...
    it("should return message when no apps found", async () => {
      ...
      const result = await registry.call("create_search_apps", { query: "nonexistent" });
    ...
    it("should use default limit of 10", async () => {
      ...
      await registry.call("create_search_apps", { query: "test" });
    ...
    it("should respect custom limit", async () => {
      ...
      await registry.call("create_search_apps", { query: "test", limit: 5 });
  ...
  describe("create_get_app", () => {
    it("should return app details with generator info", async () => {
      ...
      const result = await registry.call("create_get_app", { slug: "health/water-tracker" });
    ...
    it("should return NOT_FOUND for missing app", async () => {
      ...
      const result = await registry.call("create_get_app", { slug: "nope" });
    ...
    it("should handle app without generator", async () => {
      ...
      const result = await registry.call("create_get_app", { slug: "games/pong" });
    ...
    it("should fall back to generatedBy.id when name is null", async () => {
      ...
      const result = await registry.call("create_get_app", { slug: "games/snake" });
  ...
  describe("create_classify_idea", () => {
    it("should classify a valid idea", async () => {
      ...
      const result = await registry.call("create_classify_idea", { text: "water tracking app" });
    ...
    it("should return blocked status", async () => {
      ...
      const result = await registry.call("create_classify_idea", { text: "harmful content" });
    ...
    it("should return unclear status", async () => {
      ...
      const result = await registry.call("create_classify_idea", { text: "x" });
  ...
  describe("create_check_health", () => {
    it("should return healthy status", async () => {
      ...
      const result = await registry.call("create_check_health", { codespace_id: "cs-123" });
    ...
    it("should return unhealthy status", async () => {
      ...
      const result = await registry.call("create_check_health", { codespace_id: "cs-broken" });
  ...
  describe("create_list_top_apps", () => {
    it("should list top apps filtered by health", async () => {
      ...
      const result = await registry.call("create_list_top_apps", {});
    ...
    it("should fetch double the limit for health filtering", async () => {
      ...
      await registry.call("create_list_top_apps", { limit: 5 });
  ...
  describe("create_list_recent_apps", () => {
    it("should list recent apps filtered by health", async () => {
      ...
      const result = await registry.call("create_list_recent_apps", {});
  ...
  describe("create_get_app_status", () => {
    it("should return PUBLISHED status", async () => {
      ...
      const result = await registry.call("create_get_app_status", { slug: "games/tetris" });
    ...
    it("should return GENERATING status", async () => {
      ...
      const result = await registry.call("create_get_app_status", { slug: "games/new-game" });
    ...
    it("should return FAILED status", async () => {
      ...
      const result = await registry.call("create_get_app_status", { slug: "games/broken" });
    ...
    it("should return NOT_FOUND for missing app", async () => {
      ...
      const result = await registry.call("create_get_app_status", { slug: "nope" });
