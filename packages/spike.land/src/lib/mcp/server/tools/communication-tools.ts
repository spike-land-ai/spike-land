...
export function registerEmailTools(
    ...
    registry.registerBuilt(
        freeTool(userId)
            .tool("email_send", "Send an email from the workspace. Records the send intent with SENT status.", {
    ...
    registry.registerBuilt(
        freeTool(userId)
            .tool("email_get_status", "Get the delivery status of a sent email.", {
                workspace_slug: z.string().min(1).describe("Workspace slug."),
    ...
    registry.registerBuilt(
        freeTool(userId)
            .tool("email_list", "List recent email logs for the current user.", {
                workspace_slug: z.string().min(1).describe("Workspace slug."),
...
export function registerNotificationsTools(
    ...
    registry.registerBuilt(
        freeTool(userId)
            .tool("notification_list", "List notifications for the workspace, optionally filtered to unread only.", {
                workspace_slug: z.string().min(1).describe("Workspace slug."),
    ...
    registry.registerBuilt(
        freeTool(userId)
            .tool("notification_mark_read", "Mark one or more notifications as read.", {
                workspace_slug: z.string().min(1).describe("Workspace slug."),
    ...
    registry.registerBuilt(
        freeTool(userId)
            .tool("notification_configure_channels", "Configure notification delivery channels for the workspace.", {
                workspace_slug: z.string().min(1).describe("Workspace slug."),
    ...
    registry.registerBuilt(
        freeTool(userId)
            .tool("notification_send", "Send a notification to a specific user or the entire workspace.", {
                workspace_slug: z.string().min(1).describe("Workspace slug."),
...
export function registerNewsletterTools(
    ...
    registry.registerBuilt(
        freeTool(userId)
            .tool("newsletter_subscribe", "Subscribe an email address to the newsletter.", {
