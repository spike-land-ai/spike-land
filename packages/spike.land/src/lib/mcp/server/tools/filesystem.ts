...
export function registerFilesystemTools(
    ...
    registry.registerBuilt(
        freeTool(_userId)
            .tool("fs_read", "Read a file from the codespace virtual filesystem.\n"
    ...
    registry.registerBuilt(
        freeTool(_userId)
            .tool("fs_write", "Write or create a file in the codespace virtual filesystem.\n"
    ...
    registry.registerBuilt(
        freeTool(_userId)
            .tool("fs_edit", "Exact string replacement in a codespace file.\n"
    ...
    registry.registerBuilt(
        freeTool(_userId)
            .tool("fs_glob", "Find files by glob pattern in a codespace.\n"
    ...
    registry.registerBuilt(
        freeTool(_userId)
            .tool("fs_grep", "Search file contents in a codespace.\n"
    ...
    registry.registerBuilt(
        freeTool(_userId)
            .tool("fs_ls", "List files and directories at a path in the codespace.\n"
                + "Defaults to root (/).", {
                codespace_id: z.string().min(1).max(100).regex(/^[a-zA-Z0-9_.-]+$/),
    ...
    registry.registerBuilt(
        freeTool(_userId)
            .tool("fs_rm", "Remove a file from the codespace virtual filesystem.\n"
    ...
    registry.registerBuilt(
        freeTool(_userId)
            .tool("fs_intent", "Declare agent mission and get relevant files proactively.\n"
