...
const aliases = [
  ...
  {
    find: "@vercel/kv",
    replacement: path.resolve(root, "./vitest.mock-vercel-kv.ts"),
  },
  ...
  {
    find: "next/link",
    replacement: path.resolve(root, "../../node_modules/next/link.js"),
  },
  {
    find: "next/image",
    replacement: path.resolve(root, "../../node_modules/next/image.js"),
  },
  {
    find: "next/server",
    replacement: path.resolve(root, "../../node_modules/next/server.js"),
  },
  // Map @prisma/client to the generated Prisma client location
  {
    find: "@prisma/client",
    replacement: path.resolve(root, "./src/generated/prisma"),
  },
