  ...
  it("handles machine with compound state", () => {
    const machineExport = makeMachineExport({
      definition: {
        ...
        initial: "parent",
        states: {
          parent: { id: "parent", type: "compound", initial: "child", children: ["child"], entryActions: [], exitActions: [] },
          child: { id: "child", type: "atomic", parent: "parent", children: [], entryActions: [], exitActions: [] },
        },
        transitions: [],
        context: {},
        userId: "u1",
  ...
  it("handles machine with parallel state", () => {
    const machineExport = makeMachineExport({
      definition: {
        ...
        initial: "root",
        states: {
          root: { id: "root", type: "parallel", children: ["regionA", "regionB"], entryActions: [], exitActions: [] },
          regionA: { id: "regionA", type: "atomic", parent: "root", children: [], entryActions: [], exitActions: [] },
          regionB: { id: "regionB", type: "atomic", parent: "root", children: [], entryActions: [], exitActions: [] },
        },
        transitions: [],
        context: {},
        userId: "u1",
