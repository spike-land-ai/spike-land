...
describe("transferables", () => {
  ...
  describe("filterOutDuplicates", () => {
    ...
    it("should remove duplicate strings", () => {
      expect(filterOutDuplicates(["a", "b", "a", "c", "b"])).toEqual(["a", "b", "c"]);
    });
  ...
  describe("AVAILABLE_TRANSFERABLE_OBJECTS", () => {
    it("should have expected properties", () => {
      expect(AVAILABLE_TRANSFERABLE_OBJECTS).toHaveProperty("TransferableExists");
      expect(AVAILABLE_TRANSFERABLE_OBJECTS).toHaveProperty("StreamExists");
      expect(AVAILABLE_TRANSFERABLE_OBJECTS).toHaveProperty("ReadableStreamExists");
      expect(AVAILABLE_TRANSFERABLE_OBJECTS).toHaveProperty("WritableStreamExists");
      expect(AVAILABLE_TRANSFERABLE_OBJECTS).toHaveProperty("TransformStreamExists");
      expect(AVAILABLE_TRANSFERABLE_OBJECTS).toHaveProperty("MessageChannelExists");
      expect(AVAILABLE_TRANSFERABLE_OBJECTS).toHaveProperty("MessagePortExists");
