...
A comprehensive guide for consistent HTTP status code usage across all API
endpoints in the spike.land platform.
...
4. Update API documentation (docs/architecture/API_REFERENCE.md) as endpoints
   are migrated
