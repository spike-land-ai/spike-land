...
describe("ApiHandler", () => {
  ...
  describe("Room/Generate ID Generation", () => {
    it("should generate a new unique ID for room", async () => {
      ...
      const response = await handleApiRequest(["generate"], mockRequest, mockEnv as Env);
  ...
  describe("Room Object Routing", () => {
    ...
    it("should route to room object with name ID", async () => {
      ...
      const response = await handleApiRequest(["room", "testroom"], mockRequest, mockEnv as Env);
  ...
  describe("Default Response", () => {
    it("should return default HTML response for any unhandled route", async () => {
      ...
      const response = await handleApiRequest([""], mockRequest, mockEnv as Env);
