...
--> statement-breakpoint
CREATE UNIQUE INDEX `channel_members_channelId_userId_unique` ON `channel_members` (`channelId`,`userId`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `read_cursors_userId_channelId_unique` ON `read_cursors` (`userId`,`channelId`);--> statement-breakpoint
