...
function readThemeTokens(isDark: boolean): PlatformThemeTokens {
  ...
  return {
    ...
    chatAccent: resolveCssVarColor(TOKEN_CONFIG.chatAccent, defaults.chatAccent),
    chatAccentLight: resolveCssVarColor(TOKEN_CONFIG.chatAccentLight, defaults.chatAccentLight),
...
export function createMonacoThemeData(
  ...
  return {
    ...
    rules: [
      ...
      { token: "type.identifier", foreground: accentLight },
      { token: "class", foreground: accentLight, fontStyle: "bold" },
      { token: "identifier.function", foreground: accent, fontStyle: "bold" },
      { token: "function", foreground: accent },
      { token: "string", foreground: accentLight },
    ...
    colors: {
      ...
      "editor.lineHighlightBorder": withAlpha(tokens.chatAccent, isDark ? 0.16 : 0.08),
      ...
      "editorIndentGuide.activeBackground1": withAlpha(tokens.chatAccentLight, isDark ? 0.32 : 0.2),
      "editorWhitespace.foreground": withAlpha(tokens.border, isDark ? 0.35 : 0.45),
      "editorBracketMatch.border": tokens.chatAccentLight,
      "editorBracketMatch.background": withAlpha(tokens.chatAccent, isDark ? 0.12 : 0.06),
      ...
      "editorSuggestWidget.selectedBackground": withAlpha(tokens.chatAccent, isDark ? 0.14 : 0.08),
      "editorSuggestWidget.highlightForeground": tokens.chatAccent,
      "editorSuggestWidget.focusHighlightForeground": tokens.chatAccentLight,
      "editorSuggestWidgetStatus.foreground": tokens.mutedForeground,
      "editor.findMatchBackground": withAlpha(tokens.chatAccentLight, isDark ? 0.18 : 0.12),
      ...
      "minimap.selectionHighlight": withAlpha(tokens.chatAccentLight, isDark ? 0.18 : 0.12),
      ...
      "minimapSlider.activeBackground": withAlpha(tokens.chatAccent, isDark ? 0.4 : 0.24),
      ...
      "scrollbarSlider.activeBackground": withAlpha(tokens.chatAccent, isDark ? 0.4 : 0.24),
    },
  };
}
