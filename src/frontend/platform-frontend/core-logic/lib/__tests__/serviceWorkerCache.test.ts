...
describe("serviceWorkerCache", () => {
  ...
  it("builds the service worker URL with an absolute manifest reference", async () => {
    const { buildServiceWorkerScriptUrl } = await import("../serviceWorkerCache");
  ...
  it("handles enablement overrides for dev and production", async () => {
    const { shouldEnableServiceWorkerCacheController } = await import("../serviceWorkerCache");
  ...
  it("returns null when registration is not supported or disabled", async () => {
    const { registerServiceWorkerCacheController } = await import("../serviceWorkerCache");
  ...
  it("unregisters existing service workers and clears managed caches", async () => {
    ...
    const { disableServiceWorkerCacheController } = await import("../serviceWorkerCache");
  ...
  it("returns false when commands cannot be delivered", async () => {
    const { sendServiceWorkerCacheCommand } = await import("../serviceWorkerCache");
  ...
  it("purges caches through the active worker", async () => {
    ...
    const { purgeServiceWorkerCaches } = await import("../serviceWorkerCache");
  ...
  it("reads status replies from the worker", async () => {
    ...
    const { getServiceWorkerCacheStatus } = await import("../serviceWorkerCache");
