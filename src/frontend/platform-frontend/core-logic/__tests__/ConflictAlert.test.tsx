...
describe("ConflictAlert", () => {
  ...
  it("shows contradiction detected heading with count", () => {
    render(
      <ConflictAlert
        conflicts={[{ concept: "Variables", round: 1, detail: "Contradicts round 1" }]}
      />,
    );
  ...
  it("shows mastery reset message", () => {
    render(
      <ConflictAlert conflicts={[{ concept: "Arrays", round: 1, detail: "Conflict detail" }]} />,
    );
  ...
  it("has warning styling", () => {
    const { container } = render(
      <ConflictAlert conflicts={[{ concept: "Test", round: 1, detail: "detail" }]} />,
    );
