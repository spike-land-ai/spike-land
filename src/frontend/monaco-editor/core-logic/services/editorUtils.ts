...
export const transpileCode = memoize(
 ...
 */
function isCodeExecutionResultMessage(data: unknown): data is CodeExecutionResultMessageData {
  return (
    typeof data === "object" &&
    data !== null &&
    "type" in data &&
 ...
 */
export const runCode = async (transpiled: string): Promise<RunMessageResult | false> => {
