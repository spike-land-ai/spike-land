...
import type { Message, MessageContent, TextPart } from "../../ui/@/lib/interfaces";
 ...
 */
function applyCodeModifications(code: string, modifications: string[], applyAll = true): string {
