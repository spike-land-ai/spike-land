...
import { editor, Range, typescript, Uri } from "../../../../editor/monaco-editor.worker";
    ...
    const processUpdate = async () => {
      ...
      try {
        ...
        if (!editorModel.isEdit || importsChanged) {
          console.warn("User finished editing or imports changed, saving changes");
