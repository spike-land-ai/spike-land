    ...
    return (
      <div className="h-[100dvh] bg-obsidian-950 flex items-center justify-center text-gray-400">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="font-mono text-xs uppercase tracking-widest text-amber-neon/50">
            Initializing Studio...
          </span>
        </div>
      </div>
      ...
      <DragDropProvider>
        <div className="min-h-[100dvh] bg-obsidian-950 text-gray-200 overflow-x-hidden relative selection:bg-amber-neon/30 selection:text-white font-sans antialiased">
          ...
          <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
            ...
            <div
              className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-emerald-neon/5 blur-[160px] rounded-full animate-pulse-slow"
          ...
          <nav className="fixed top-0 left-0 w-full h-16 md:h-20 flex items-center justify-between px-6 md:px-10 z-50 backdrop-blur-xl bg-obsidian-950/40 border-b border-white/5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-black tracking-tight uppercase">
                Pixel<span className="text-amber-neon">Studio</span>
              </span>
            </div>
            <div className="flex items-center gap-4 md:gap-6">
              <a
                href="#features"
                className="hidden sm:block text-[10px] font-black uppercase tracking-widest text-gray-500 hover:text-white transition-colors"
              >
                Abstractions
              </a>
              <button
          ...
          <section className="relative pt-32 md:pt-40 pb-12 md:pb-24 px-6 md:px-12 z-10 flex flex-col items-center text-center max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-white max-w-4xl mb-6 leading-[0.9] animate-in fade-in slide-in-from-bottom-4 duration-1000">
              CREATE WITH{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-neon via-amber-400 to-amber-600">
                AI
              </span>
            </h1>
          ...
          <section
            id="features"
            className="relative px-6 md:px-12 py-12 md:py-20 z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8"
          >
            {[
              {
                icon: Layout,
                ...
                color: "amber-neon",
                text: "No grids. No folders. Just an endless expanse for your assets to breathe and evolve.",
              },
              {
                icon: Cpu,
                title: "Neural Orchestrator",
                color: "emerald-neon",
                text: "Chain 40+ MCP tools into complex creative workflows with simple natural language.",
              },
              {
                icon: Shield,
                title: "Local-First Privacy",
                color: "blue-400",
                text: "Your tokens and assets remain within your isolate. Direct provider handshake only.",
              },
            ].map((feat, i) => (
              <div
                key={i}
                className="glass-panel rounded-3xl p-8 border-white/5 space-y-4 hover:border-white/20 transition-all group"
              >
          ...
          <section
            id="network"
            className="relative px-6 md:px-12 py-12 md:py-24 z-10 max-w-7xl mx-auto border-t border-white/5"
          >
              ...
              <div className="lg:w-1/3 space-y-8">
                <div className="space-y-3 text-center lg:text-left">
                  <h2 className="text-3xl font-black text-white tracking-tighter uppercase">
                    The Neural
                    <br />
                    <span className="text-emerald-neon">Stream</span>
                  </h2>
                  <p className="text-sm text-gray-500 font-medium leading-relaxed">
                    Observe real-time manifestations across the Pixel Studio network. Every pixel is
                    proof of an idea taking form.
                  </p>
                </div>
  ...
  return (
    <DragDropProvider>
      <div className="h-[100dvh] flex flex-col md:flex-row bg-obsidian-950 text-gray-200 overflow-hidden font-sans antialiased selection:bg-amber-neon/20">
        <Sidebar
          active={workspace}
          onNavigate={(ws) => setWorkspace(ws as Workspace)}
          user={user}
          onLogout={logout}
        />
              ...
              <div className="relative" ref={userMenuRef}>
                ...
                {showUserMenu && (
                  ...
                  >
                    ...
                    {user?.email && (
                      <div className="text-[9px] text-gray-500 truncate mb-3 font-medium">
                        {user.email}
                      </div>
                    )}
                    <button
