...
const PRE_GENERATED = [
  ...
  },
  {
    id: "demo-2",
    prompt:
      "Ethereal crystal floating in a dark void, emitting soft bioluminescent glow, macro photography, sharp focus",
    url: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "demo-3",
    prompt:
      "Minimalist geometric architecture in desert landscape, surreal lighting, warm color palette, 3d render",
    url: "https://images.unsplash.com/photo-1518640467707-6811f4a6ab73?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "demo-4",
    prompt:
      "Vintage mechanical typewriter overgrown with glowing alien flora, intricate details, moody atmosphere",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-[10px] font-black text-amber-neon uppercase tracking-[0.3em] animate-pulse">
          Neural Flux...
        </p>
      </div>
