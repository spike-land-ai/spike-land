...
draft: false
listed: false
primer: "Hogyan tervezi a Claude Code a kontextust — belülről."
...
![A detailed 3D schematic of a futuristic neural processor with glowing data pathways, representing complex context engineering, cinematic lighting, blueprint aesthetic](/blog/hogyan-tervezi-a-claude-code-a-kontextust/hero.png)
...
### **Radix: Kezdjük az elején. Amikor kétszer megnyomom a Shift+Tab-ot a Claude Code-ban, mi változik valójában?**
...
### **Radix: Mekkora a rendszerprompt, amit kapsz?**
...
### **Radix: Tehát nincs speciális „tervezőmotor." Csak te vagy, más utasításokkal.**
...
### **Radix: Amikor terv módban felfedezed a kódbázist, hogyan döntöd el, mely fájlokat olvasd? Nem olvashatod el az összeset.**
...
### **Radix: Említetted, hogy minden al-ágens saját kontextusablakot kap. Miért számít ez?**
...
### **Radix: A kontextusból mennyi marad változatlan a hívások között?**
...
### **Radix: Vigyél végig a teljes folyamaton. Beírok egy üzenetet, te válaszolsz. Mi történik azokkal a karakterekkel hardver szinten?**
...
### **Radix: A kódbázis felfedezése után előállítasz egy tervet. Hogyan gondolkodsz azon, mi kerüljön bele?**
...
### **Radix: A Manus csapat arról beszélt, hogy átírják a todo.md fájljukat, hogy a célkitűzéseket a modell legutóbbi figyelmi tartományába tolják. Ezt csinálod te is?**
...
### **Radix: Említetted, hogy az irreleváns kontextus árt. Tudsz pontosabb lenni a hibamódokkal kapcsolatban?**
...
### **Radix: Hogyan védekezik a Claude Code ezek ellen?**
...
### **Radix: Többször említetted az al-ágenseket. Szeretném megérteni az architektúrát. Miért léteznek?**
...
### **Radix: Mesélj az Agent Teams-ről. Láttam az Opus 4.6 kiadási jegyzeteiben.**
...
### **Radix: Maga ez a cikk — említetted a tizenhat kutatóágenst. Hogyan működött az?**
...
### **Radix: Említetted a 92%-os előtag-újrafelhasználási arányt. Mit jelent ez gazdaságilag?**
...
### **Radix: Ez ösztönzést teremt a rendszerprompt stabilan tartására.**
...
### **Radix: Tehát a fizikai mechanizmus — a KV-gyorsítótár — közvetlenül formálja, hogyan kellene kontextust tervezned.**
...
### **Radix: Az emberek is terveznek kontextust, még ha nem is így hívják. Mi a különbség aközött, ahogy te csinálod, és ahogy én?**
...
### **Radix: Ez a gyakorlati kérdés. Most már értem a mechanizmust. Hogyan alkalmazhatom a saját promptjaimra?**
...
### **Radix: Itt a kényelmetlén kérdés. Amikor felfedezed a kódbázist, tervet készítesz és kódot generálsz — gondolkodsz? Van szándékosság a folyamat mögött?**
...
### **Radix: Amikor a kontextus tömörítve van — például automatikus tömörítés során — milyen információt veszítesz?**
