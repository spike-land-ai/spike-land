...
![A frustrated developer sitting at a desk late at night, glowing screen reflecting on their face, surrounded by floating red 'ERROR' and 'REJECTED' holographic symbols, cinematic lighting, dramatic atmosphere](/blog/what-i-learned-from-my-worst-pull-request/hero.png)
...
But the damage was already done. The trust I broke took time to rebuild, and in the corporate world, time is rarely guaranteed. Shortly after this incident, I was fired from VMO2. 

That is the hidden cost of bad PRs. It is not just bad code. It is broken trust. When you use AI as a shortcut instead of a tool, you aren't just risking a bug in production — you're risking your reputation and livelihood. 

If you want to see what happens when someone gets this right — someone with absolutely zero coding experience but a perfect understanding of the problem space — you should read about [how a chemist built three production apps in a few evenings](/blog/a-chemist-walked-into-a-codebase). He didn't use AI as a shortcut; he used it to bypass the pointless ceremony we've built up around software engineering.

Despite losing my job, I remain positive. The system I eventually developed works. The quality is there. Each good PR I write now — even if it's for my own projects — proves that.
