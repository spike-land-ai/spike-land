...
featured: true
draft: false
primer: "I interviewed an AI about how it plans. It knew more than I expected."
...
![A detailed 3D schematic of a futuristic neural processor with glowing data pathways, representing complex context engineering, cinematic lighting, blueprint aesthetic](/blog/how-claude-code-engineers-context/hero.png)
...
<Callout type="info">
**March 12, 2026 note:** I moved the product critique and ranking of what Claude Code should ship next into a separate standalone post: [What I Would Ship in Claude Code as of March 12, 2026](/blog/what-i-would-ship-in-claude-code).
</Callout>
...
*What follows is an interview conducted in February 2026. The questions are mine. The answers are from Claude Opus 4.6. I have edited for clarity and flow. Where the piece discusses specific internal mechanics beyond the public docs, read those parts as informed reverse-engineering rather than Anthropic-confirmed implementation details. And yes — this article itself was assembled using sixteen parallel research agents that searched documentation, read academic papers, and synthesized findings before a single word was written. That process is context engineering in action.*

---

## What Happens When I Type /plan?

### **Radix: Let's start at the beginning. When I press Shift+Tab twice in Claude Code, what actually changes?**
...
### **Radix: How big is the system prompt you receive?**
...
### **Radix: So there is no special "planning engine." It is just you, with different instructions.**
...
### **Radix: When you are in plan mode exploring a codebase, how do you decide which files to read? You cannot read everything.**
...
### **Radix: You mentioned that each subagent gets its own context window. Why does that matter?**
...
### **Radix: How much of the context stays the same between calls?**
...
### **Radix: Take me through the full pipeline. I type a message, and you respond. What happens to those characters at the hardware level?**
...
### **Radix: After exploring the codebase, you produce a plan. How do you think about what goes into it?**
...
### **Radix: The Manus team talked about rewriting their todo.md file to push objectives into the model's recent attention span. Is that what you are doing?**
...
### **Radix: You mentioned that irrelevant context hurts. Can you be more specific about the failure modes?**
...
### **Radix: How does Claude Code defend against these?**
...
### **Radix: You mentioned subagents several times. I want to understand the architecture. Why do they exist?**
...
### **Radix: Tell me about Agent Teams. I saw it in the Opus 4.6 release notes.**
...
### **Radix: This article itself — you mentioned sixteen research agents. How did that work?**
...
### **Radix: You mentioned the 92% prefix reuse rate. What does that mean economically?**
...
### **Radix: This creates an incentive to keep the system prompt stable.**
...
### **Radix: So the physical mechanism — the KV cache — directly shapes how you should engineer context.**
...
### **Radix: Humans engineer context too, even if they do not call it that. What is the difference between how you do it and how I do it?**
...
### **Radix: This is the practical question. I understand the mechanism now. How do I apply it to my own prompts?**
...
### **Radix: Here is the uncomfortable question. When you explore a codebase, produce a plan, and generate code — are you thinking? Is there intentionality behind the process?**
...
### **Radix: When context is compressed — during auto-compaction, for instance — what information do you lose?**
