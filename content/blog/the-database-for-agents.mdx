...
![defineBlock(): a single function that packages schema, procedures, and MCP tools into a composable unit running on any runtime](/blog/the-database-for-agents/hero.jpeg)
